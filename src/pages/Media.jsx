...
const allImages = [
  ...
  { src: '/src/assets/Img/KAV03916.webp', category: 'Performances', caption: 'On Stage' },
  { src: '/src/assets/Img/KAV03931.webp', category: 'Performances', caption: 'Performance Highlight' },
  { src: '/src/assets/Img/KAV03953.webp', category: 'Performances', caption: 'In Full Rendition' },
  { src: '/src/assets/Img/KAV03957.webp', category: 'Performances', caption: 'Concert Moment' },
  { src: '/src/assets/Img/KAV03964.webp', category: 'Performances', caption: 'Stage Presence' },
  { src: '/src/assets/Img/KAV03966.webp', category: 'Performances', caption: 'Vocal Artistry' },
  { src: '/src/assets/Img/KAV03983.webp', category: 'Performances', caption: 'Deep in Melody' },
  { src: '/src/assets/Img/KAV03992.webp', category: 'Performances', caption: 'Raga Exploration' },
  { src: '/src/assets/Img/KAV03998.webp', category: 'Performances', caption: 'Musical Moment' },
  { src: '/src/assets/Img/KAV04002.webp', category: 'Performances', caption: 'On the Concert Stage' },
  { src: '/src/assets/Img/KAV04009.webp', category: 'Performances', caption: 'Performance' },
  // Awards — celebration, felicitation moments
  { src: '/src/assets/Img/KAV04020.webp', category: 'Awards', caption: 'Felicitation Ceremony' },
  { src: '/src/assets/Img/KAV04031.webp', category: 'Awards', caption: 'Award Recognition' },
  { src: '/src/assets/Img/KAV04034.webp', category: 'Awards', caption: 'Honoured at Ceremony' },
  { src: '/src/assets/Img/KAV04037.webp', category: 'Awards', caption: 'Award Moment' },
  { src: '/src/assets/Img/KAV04039.webp', category: 'Awards', caption: 'Recognition' },
  { src: '/src/assets/Img/KAV04045.webp', category: 'Awards', caption: 'Felicitation' },
  { src: '/src/assets/Img/KAV04066.webp', category: 'Awards', caption: 'Award Ceremony' },
  { src: '/src/assets/Img/KAV04073.webp', category: 'Awards', caption: 'Honoured' },
  { src: '/src/assets/Img/KAV04076.webp', category: 'Awards', caption: 'Celebration' },
  // International — international concerts and collaborations
  { src: '/src/assets/Img/KAV04096.webp', category: 'International', caption: 'International Stage' },
  { src: '/src/assets/Img/KAV04101.webp', category: 'International', caption: 'Global Performance' },
  { src: '/src/assets/Img/KAV04107.webp', category: 'International', caption: 'Overseas Concert' },
  { src: '/src/assets/Img/KAV04114.webp', category: 'International', caption: 'International Collaboration' },
  { src: '/src/assets/Img/KAV04118.webp', category: 'International', caption: 'World Stage' },
  { src: '/src/assets/Img/KAV04122.webp', category: 'International', caption: 'Cross-Cultural Music' },
  { src: '/src/assets/Img/KAV04127.webp', category: 'International', caption: 'International Music Festival' },
  { src: '/src/assets/Img/KAV04139.webp', category: 'International', caption: 'Global Footprint' },
  // Behind the Scenes — candid, rehearsal, backstage
  { src: '/src/assets/Img/KAV04146.webp', category: 'Behind the Scenes', caption: 'Backstage Moment' },
  { src: '/src/assets/Img/KAV04151.webp', category: 'Behind the Scenes', caption: 'Pre-Concert Preparation' },
  { src: '/src/assets/Img/KAV04153.webp', category: 'Behind the Scenes', caption: 'Candid Rehearsal' },
  { src: '/src/assets/Img/KAV04156.webp', category: 'Behind the Scenes', caption: 'Behind the Curtain' },
  { src: '/src/assets/Img/KAV04157.webp', category: 'Behind the Scenes', caption: 'Candid' },
  { src: '/src/assets/Img/KAV04161.webp', category: 'Behind the Scenes', caption: 'Rehearsal' },
  { src: '/src/assets/Img/KAV04165.webp', category: 'Behind the Scenes', caption: 'With Co-Artists' },
  // More Performances
  { src: '/src/assets/Img/KAV04181.webp', category: 'Performances', caption: 'Concert Performance' },
  { src: '/src/assets/Img/KAV04188.webp', category: 'Performances', caption: 'Live on Stage' },
  { src: '/src/assets/Img/KAV04195.webp', category: 'Performances', caption: 'In Concert' },
  { src: '/src/assets/Img/KAV04201.webp', category: 'Performances', caption: 'Stage Moment' },
  { src: '/src/assets/Img/KAV04204.webp', category: 'Performances', caption: 'Musical Rendition' },
  { src: '/src/assets/Img/KAV04208.webp', category: 'Performances', caption: 'Vocal Excellence' },
  { src: '/src/assets/Img/KAV04223.webp', category: 'Performances', caption: 'Melodic Evening' },
  // More Behind the Scenes
  { src: '/src/assets/Img/KAV04236.webp', category: 'Behind the Scenes', caption: 'Candid Smile' },
  { src: '/src/assets/Img/KAV04238.webp', category: 'Behind the Scenes', caption: 'Off Stage' },
  { src: '/src/assets/Img/KAV04241.webp', category: 'Behind the Scenes', caption: 'Warmth Backstage' },
  { src: '/src/assets/Img/KAV04249.webp', category: 'Behind the Scenes', caption: 'Artist\'s World' },
  // More International
  { src: '/src/assets/Img/KAV04267.webp', category: 'International', caption: 'International Concert' },
  { src: '/src/assets/Img/KAV04285.webp', category: 'International', caption: 'World Music Platforms' },
  { src: '/src/assets/Img/KAV04287.webp', category: 'International', caption: 'Global Performer' },
  // More Awards
  { src: '/src/assets/Img/KAV04304.webp', category: 'Awards', caption: 'Award Season' },
  { src: '/src/assets/Img/KAV04313.webp', category: 'Awards', caption: 'Felicitated' },
  { src: '/src/assets/Img/KAV04315.webp', category: 'Awards', caption: 'Recognition Ceremony' },
  { src: '/src/assets/Img/KAV04318.webp', category: 'Awards', caption: 'Musical Honours' },
  { src: '/src/assets/Img/KAV04341.webp', category: 'Awards', caption: 'Celebrated Artiste' },
  { src: '/src/assets/Img/KAV04352.webp', category: 'Awards', caption: 'Achievement' },
  { src: '/src/assets/Img/1.jpg',         category: 'Performances', caption: 'Recital' },
];
  ...
  return (
    <div className="bg-cream animate-fade-in relative pb-24">
      ...
      <PageHero 
        ...
        bgImage="/src/assets/Img/KAV03916.webp"
      />
